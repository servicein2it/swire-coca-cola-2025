...
class FAQRegisWidget extends StatefulWidget {
  ...
  static String routeName = 'FAQRegis';
  static String routePath = '/fAQRegis';
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'ivej8stk' /* 08:00 - 20:00 at the Hotel Lob... */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'auenm40k' /* (Remark: For late arrival afte... */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'huuq8coa' /* 07:00 - 17:00 at the Grand Bal... */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
