...
import 'team_profileold_model.dart';
export 'team_profileold_model.dart';

class TeamProfileoldWidget extends StatefulWidget {
  const TeamProfileoldWidget({super.key});

  static String routeName = 'TeamProfileold';
  static String routePath = '/teamProfileold';

  @override
  State<TeamProfileoldWidget> createState() => _TeamProfileoldWidgetState();
}

class _TeamProfileoldWidgetState extends State<TeamProfileoldWidget> {
  late TeamProfileoldModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TeamProfileoldModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<TeamprofileRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<TeamprofileRecord> teamProfileoldTeamprofileRecordList =
            snapshot.data!;
                          ...
                          Padding(
                            ...
                            child: FlutterFlowChoiceChips(
                              options: [
                                ...
                                ChipData(FFLocalizations.of(context).getText(
                                  '16h253sk' /* Special visitor */,
                                )),
                                ChipData(FFLocalizations.of(context).getText(
                                  '7gkxnggy' /* Australia */,
                                )),
                                ChipData(FFLocalizations.of(context).getText(
                                  '65pvcwp5' /* New Zealand */,
                                )),
                                ChipData(FFLocalizations.of(context).getText(
                                  '7szsgj4t' /* EMAK India */,
                                )),
                                ...
                                ChipData(FFLocalizations.of(context).getText(
                                  'h14l2wbt' /* Greater China China */,
                                )),
                                ChipData(FFLocalizations.of(context).getText(
                                  'inrdrlra' /* Greater China Hong Kong */,
                                )),
                                ChipData(FFLocalizations.of(context).getText(
                                  '9sunkq3z' /* Greater China Taiwan */,
                                )),
                                ChipData(FFLocalizations.of(context).getText(
                                  '3rgf1ddd' /* Japan */,
                                ))
